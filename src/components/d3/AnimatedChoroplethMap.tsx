...
const AnimatedChoroplethMap: React.FC<AnimatedChoroplethMapProps> = ({
  ...
  return (
    <div className="relative p-4">
      ...
      <div ref={tooltipRef} className="fixed bg-card text-foreground border border-border rounded p-2 pointer-events-none text-sm z-[200] shadow-lg" style={{ display: 'none', whiteSpace: 'nowrap' }}></div>
    </div>
  );
};
